# -*- coding: utf-8 -*-
"""
Created on Tue Jul 19 19:57:21 2022
...
while (cap.read()):
        ...
        #Mengkonversi Nilai Pembacaan Pixel
        ...
        for cnt in contours:
            ...
            cv2.putText(orig, "L: {:.1f}inch".format(lebar_pixel/25.5),(int(trbrX + 10), int(trbrY)), cv2.FONT_HERSHEY_SIMPLEX,0.7, (0,0,255), 2)
            cv2.putText(orig, "P: {:.1f}inch".format(panjang_pixel/25.5),(int(tltrX - 15), int(tltrY - 10)), cv2.FONT_HERSHEY_SIMPLEX,0.7, (0,0,255), 2)
